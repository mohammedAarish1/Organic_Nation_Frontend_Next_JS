...
import Image from "next/image";
import { MediaItem, MediaViewer } from "../mediaViewer";
...
export default function ProductImageGallery({
  ...
  // Convert images → MediaItem[] once, memoized
      ...
      >
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-linear-to-t from-black/20 via-transparent to-transparent opacity-0 transition-all duration-300 group-hover:opacity-100" />
        ...
        <div className="scrollbar-hide flex space-x-4 overflow-x-auto p-2">
          {images.map((image, index) => (
            <motion.button
              ...
              className={`relative h-24 w-24 shrink-0 overflow-hidden rounded-2xl border-3 transition-all duration-300 ${
                selectedImage === index
                  ? "scale-105 transform shadow-xl ring-4 ring-amber-600"
                  : "border-amber-200 shadow-md hover:scale-110"
              }`}
