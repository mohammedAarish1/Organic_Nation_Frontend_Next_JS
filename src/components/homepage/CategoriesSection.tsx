...
//   return (
//     <section className="relative overflow-hidden bg-linear-to-b from-white to-emerald-50/30 py-12 sm:py-16">
...
export default function CategoriesSection() {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-white to-emerald-50/30 py-4">
      {/* Decorative Background Elements */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-30">
        <div className="absolute top-20 -left-20 h-64 w-64 rounded-full bg-amber-200 blur-3xl" />
        <div className="absolute -right-20 bottom-20 h-64 w-64 rounded-full bg-emerald-200 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <SectionHeader
          subTitle="Browse by Category"
          title="Explore Our Range"
          content="From traditional pickles to pure honey, discover our carefully curated collection of organic products"
        />

        {/* Scrollable Categories */}
        <ArrowButtonWrapper scrollAmount={340}>
          {categories.map((category, index) => (
            <div
              key={category.id}
              className="w-[280px] flex-none snap-start sm:w-[320px]"
